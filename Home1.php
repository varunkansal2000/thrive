...
.sr-only-focusable:active, .sr-only-focusable:focus {
  ...
  overflow: visible;
  clip: auto; }
</style><script src="./Home1 - Chhaya Coaching Centre_files/sdk-insights-tracker" async="" defer=""></script></head>
...
<div class="kv-background-inner " data-image="background-image:1.jpg" style="background-image: url(1.jpg);
    
    
    background-color: rgb(80,80,80);
    opacity: 0.5;; background-image: url(1.jpg);; background-image: url(1.jpg);"></div>
</div>
...
<li><a href="./Home1.php" data-uri-path="/" target="_self" class="active">Home</a></li>
<li><a href="./Maths.php" data-uri-path="/maths" target="_self">Class</a></li>
...
<h1 class="section-title page-title--md" data-type="text">DSCE-CSE<span data-prop="title" class="ck-editable-element" data-editable="basic" style="display:none;"></span></h1>
<p class="section-subtitle section-subtitle--md" data-type="text">By ayush,varun,vedansh<span data-prop="subtitle" class="ck-editable-element" data-editable="basic" style="display:none;"></span></p>
</div>
</div>
...
<div class="buttons">
<a class="
    button-lg mx-2 mb-3 undefined
    button-dynamic-buttons kv-button-instant-edit
    button-primary
  " data-index="0" data-type="button" tabindex="1907" data-href="maths" href="./Maths.php" data-property="buttons">
<div style="" class="button-has-title">Class<div data-editable="button" data-prop="buttons.0.title" style="display:none;">
</div></div>
</a><a class="
    button-lg mx-2 mb-3 undefined
    button-dynamic-buttons kv-button-instant-edit
    button-primary
  " data-index="1" data-type="button" tabindex="1908" data-href="science-" href="./Science.php" data-property="buttons">
<div style="" class="button-has-title">Lab<div data-editable="button" data-prop="buttons.1.title" style="display:none;">
</div></div>
</a>
</div>
</div>
...
<script type="text/javascript" src="./Home1 - Chhaya Coaching Centre_files/2635a49c1e8a4f6dcb82.bundle.js.download"></script><script type="text/javascript" src="./Home1 - Chhaya Coaching Centre_files/bundle.js.download"></script>
