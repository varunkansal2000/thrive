...
// REGISTER USER
  ...
  if (count($errors) == 0) {
    $query = "INSERT INTO login (phone, password, name, email, ip, about, semester, batch) 
              VALUES('$phone', '$password', '$name', '$email', '' ,'$about', '$semester', '$batch')";
...
<li><a href="./teacher" data-uri-path="/teacher" target="_self" class="active">Class Adding</a></li>
...
<div class="card-head">
<h2 class="section-title on_card section-title--sm" data-type="text">Student Registeration<span data-prop="title" class="ck-editable-element" data-editable="basic" style="display:none;"></span></h2>

<p class="section-description on_card body--md" data-type="text">Enter the details of the students<span data-prop="description" class="ck-editable-element" data-editable="basic" style="display:none;"></span></p>
</div>
...
<label>Name</label>
<input class="form-control"name="name" id="fieldEmail" type="text" placeholder="Enter the name" required="" data-namelabel="video">
</div>
<div class="form-group fieldEmail-container ">
<label>Phone No</label>
<input class="form-control"name="phone" id="fieldEmail" type="text" placeholder="Enter the Phone no" required="" data-namelabel="question">
</div>
<div class="form-group fieldEmail-container ">
<label>Email</label>
<input class="form-control"name="email" id="fieldEmail" type="text" placeholder="Enter the email id" required="" data-namelabel="video">
</div>
<div class="form-group fieldEmail-container ">
<label>Password</label>
<input class="form-control"name="password" id="fieldEmail" type="text" placeholder="Enter the password" required="" data-namelabel="video">
</div>
<div class="form-group fieldFirstName-container ">
<label>Semester</label>
<input class="form-control" name="semester" id="fieldFirstName" type="text" placeholder="Enter the semester" required="" data-namelabel="semester" aria-invalid="false" >
</div><div class="form-group fieldEmail-container ">
<label>Batch</label>
<input class="form-control" name="batch" id="fieldEmail" type="text" placeholder="Enter the batch" required="" data-namelabel="batch">
</div>
...
<nav>
<ul>
<li><a href="./teacher" data-uri-path="/teacher" class="opaque body-text body--sm active">Class Adding</a></li>
<li>
