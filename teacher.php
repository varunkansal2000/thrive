...
// REGISTER USER
  ...
  if (count($errors) == 0) {
    $query = "INSERT INTO teacher (semester, batch, question, video, topic, date1, time1) 
              VALUES('$semester', '$batch', '$question', '$video' ,'$topic', '$date1' ,'$time1')";
...
<meta http-equiv="content-language" content="en"><title>Teacher - DSCE-CSE</title>
...
<li><a href="./register" data-uri-path="/register" target="_self" class="active">Register</a></li>
...
<div class="card-head">
<h2 class="section-title on_card section-title--sm" data-type="text">Teacher<span data-prop="title" class="ck-editable-element" data-editable="basic" style="display:none;"></span></h2>

<p class="section-description on_card body--md" data-type="text">Enter the details to be sended to the students<span data-prop="description" class="ck-editable-element" data-editable="basic" style="display:none;"></span></p>
</div>
...
<input class="form-control" name="semester" id="fieldFirstName" type="text" placeholder="semester" required="" data-namelabel="semester" aria-invalid="false" >
</div><div class="form-group fieldEmail-container ">
<label>Batch</label>
<input class="form-control" name="batch" id="fieldEmail" type="text" placeholder="batch" required="" data-namelabel="batch">
</div>
<div class="form-group fieldEmail-container ">
<label>Question For Lab</label>
<input class="form-control"name="question" id="fieldEmail" type="text" placeholder="question"  data-namelabel="question">
</div>
<div class="form-group fieldEmail-container ">
<label>Video Link</label>
<input class="form-control"name="video" id="fieldEmail" type="text" placeholder="video link"  data-namelabel="video">
</div>
<div class="form-group fieldEmail-container ">
<label>Topic Of video</label>
<input class="form-control"name="topic" id="fieldEmail" type="text" placeholder="Topic of video" data-namelabel="video">
</div>
<div class="form-group fieldEmail-container ">
<label>Date Of CLASS </label>
<input class="form-control"name="date" id="fieldEmail" type="text" placeholder="dd-mm-yyyy" required="" data-namelabel="video">
</div>
<div class="form-group fieldEmail-container ">
<label>Time Of CLASS</label>
<input class="form-control"name="time1" id="fieldEmail" type="text" placeholder="hh:ss" required="" data-namelabel="video">
</div>
...
<div style="" class="button-has-title"><input type="submit"value="Submit"><div data-editable="button" data-prop="formData.submitButton.title" style="display:none;">
</div></div>
</a>
</div>
 </div>
...
<nav>
<ul>
<li><a href="./register" data-uri-path="/register" class="opaque body-text body--sm active">Register</a></li>
<li>
<a href="./" data-uri-path="/" class="opaque body-text body--sm active">Logout</a>
</li>
</ul>
</nav>
</div>
